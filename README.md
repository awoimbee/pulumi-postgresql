[![Actions Status](https://github.com/awoimbee/pulumi-postgresql/workflows/master/badge.svg)](https://github.com/awoimbee/pulumi-postgresql/actions)
[![Slack](http://www.pulumi.com/images/docs/badges/slack.svg)](https://slack.pulumi.com)
[![NPM version](https://badge.fury.io/js/%40pulumi%2Fpostgresql.svg)](https://www.npmjs.com/package/@awoimbee-pulumi/postgresql)
...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/awoimbee/pulumi-postgresql/sdk/v3/go)](https://pkg.go.dev/github.com/awoimbee/pulumi-postgresql/sdk/v3/go)
[![License](https://img.shields.io/npm/l/%40pulumi%2Fpulumi.svg)](https://github.com/awoimbee/pulumi-postgresql/blob/master/LICENSE)
...
To use from JavaScript or TypeScript in Node.js, install using either `npm`:
    ...
    $ npm install @awoimbee-pulumi/postgresql

or `yarn`:

    $ yarn add @awoimbee-pulumi/postgresql
...
To use from Go, use `go get` to grab the latest version of the library
    ...
    $ go get github.com/awoimbee/pulumi-postgresql/sdk/v3
